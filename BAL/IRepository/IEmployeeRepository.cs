...
namespace Payrollfix_poc.IRepository
{
    public interface IEmployeeRepository
    {
        ...
        Task<Employee> CheckEmployeeByEmail(ForgotPasswordViewModel forgotPassword);
		Task<Employee> ValidateEmployee(LoginViewModel login);
        ...
        Task<LoginActivity> GetLoginActivity(int? employeeid);
