		...
		public async Task<IActionResult> Login(LoginViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				var user = await _context.Employee
										 .FirstOrDefaultAsync(e => e.EmployeeId == model.EmployeeId && e.Password == model.Password);
				...
				if (user != null)
				{
					...
					return RedirectToAction("Dashboard", "Employee", new { employeeid = user.EmployeeId });
				}
